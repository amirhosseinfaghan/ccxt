...
class bit24(Exchange, ImplicitAPI):
    ...
    async def fetch_markets(self, symbols: Strings = None, params={}) -> List[Market]:
        ...
        """
        response = await self.publicGetApiExternalTokenbazCryptocurrencyPricing(params)
        ...
        for i in range(0, len(marketKeys)):
            ...
            for index in range(0, len(quotes)):
                ...
                market = await self.parse_market(response[base][quote])
    ...
    async def fetch_tickers(self, symbols: Strings = None, params={}) -> Tickers:
        ...
        for i in range(0, len(marketKeys)):
            ...
            for index in range(0, len(quotes)):
                ...
                ticker = await self.parse_ticker(response[base][quote])
