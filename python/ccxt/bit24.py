...
class bit24(Exchange, ImplicitAPI):
    ...
    def fetch_markets(self, symbols: Strings = None, params={}) -> List[Market]:
        ...
        """
        response = self.publicGetApiExternalTokenbazCryptocurrencyPricing(params)
        ...
        for i in range(0, len(marketKeys)):
            ...
            for index in range(0, len(quotes)):
                ...
                market = self.parse_market(response[base][quote])
    ...
    def fetch_tickers(self, symbols: Strings = None, params={}) -> Tickers:
        ...
        for i in range(0, len(marketKeys)):
            ...
            for index in range(0, len(quotes)):
                ...
                ticker = self.parse_ticker(response[base][quote])
