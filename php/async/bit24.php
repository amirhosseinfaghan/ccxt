...
class bit24 extends Exchange {
    ...
    public function fetch_markets(?array $symbols = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbols, $params) {
             ...
             */
            $response = Async\await($this->publicGetApiExternalTokenbazCryptocurrencyPricing ($params));
            ...
            for ($i = 0; $i < count($marketKeys); $i++) {
                ...
                for ($index = 0; $index < count($quotes); $index++) {
                    ...
                    $market = Async\await($this->parse_market($response[$base][$quote]));
                    $result[] = $market;
                }
            }
            return $result;
        ...
        return Async\async(function () use ($symbols, $params) {
            ...
            for ($i = 0; $i < count($marketKeys); $i++) {
                ...
                for ($index = 0; $index < count($quotes); $index++) {
                    ...
                    $ticker = Async\await($this->parse_ticker($response[$base][$quote]));
